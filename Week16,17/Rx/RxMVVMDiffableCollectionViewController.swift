//
//  RxMVVMDiffableCollectionViewController.swift
//  Week16,17
//
...
class RxMVVMDiffableCollectionViewController : UIViewController {
    
    @IBOutlet weak var searchBar: UISearchBar!
    @IBOutlet weak var collectionView: UICollectionView!
    
    var viewModel = RxDiffableViewModel()
...
//        searchBar.delegate = self
        ...
        viewModel.photoList
            .withUnretained(self)
            .subscribe(onNext: { (vc, photo) in //뷰모델에 photoList 초기화값이 빈배열이므로 처음에는 화면에 아무것도 표시 안됨
...
extension RxMVVMDiffableCollectionViewController: UICollectionViewDelegate {
...
//extension RxMVVMDiffableCollectionViewController: UISearchBarDelegate {
...
extension RxMVVMDiffableCollectionViewController {
